...
A multi-loader update of [StatsSearch](https://modrinth.com/mod/statssearch) by gbl
...
SearchStats uses code from gbl's [StatsSearch](https://github.com/gbl/StatsSearch) mod, under license.
