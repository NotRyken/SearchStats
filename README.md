...
Adds a search bar to the statistics screen.

A multi-loader update of [StatsSearch](https://modrinth.com/mod/statssearch).
...
Simply type your query and the statistics list will be filtered for matching entries, allowing you to quickly find 
anything.

<table style="width:100%;">
  <tr>
    <td style="width:50%;"><img src="https://raw.githubusercontent.com/TerminalMC/SearchStats/HEAD/assets/images/stats_01.png" style="width:100%;"></td>
    <td style="width:50%;"><img src="https://raw.githubusercontent.com/TerminalMC/SearchStats/HEAD/assets/images/stats_02.png" style="width:100%;"></td>
  </tr>
</table>

### Credits

SearchStats is based on [StatsSearch](https://github.com/gbl/StatsSearch) by gbl, and includes code reused under 
license.
